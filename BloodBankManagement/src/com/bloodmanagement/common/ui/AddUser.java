...
public class AddUser extends JFrame implements ActionListener {
	...
	public AddUser() {
		...
		btnAdd.setIcon(new ImageIcon(AddUser.class.getResource("/res/Add new.png")));
		btnAdd.setBounds(51, 357, 89, 23);
		contentPane.add(btnAdd);
		
		btnClose = new JButton("Close");
		btnClose.setIcon(new ImageIcon(AddUser.class.getResource("/res/Exit application.png")));
		...
		label.setIcon(new ImageIcon(AddUser.class.getResource("/res/all page background image.png")));
