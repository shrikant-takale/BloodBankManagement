 ...
 * @author ashu
 */
public class SearchBloodGroup extends JFrame {
   ...
   Connection con;
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(92, 113, 452, 326);
        ...
        label = new JLabel("");
        label.setIcon(new ImageIcon(SearchBloodGroup.class.getResource("/res/all page background image.png")));
        label.setBounds(0, 0, 584, 450);
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {                                      
    	...
    	String textvalue = txtSearch.getText();
				...
				String sql = "select * from donor where blood_group like '%"+textvalue+"%'";
