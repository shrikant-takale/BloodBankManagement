...
public class SearchByName extends JFrame {
   ...
   Connection con;
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(83, 113, 452, 326);
        ...
        label = new JLabel("");
        label.setIcon(new ImageIcon(SearchByName.class.getResource("/res/all page background image.png")));
        label.setBounds(10, 0, 574, 450);
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {                                      
    	...
    	String textvalue = txtSearch.getText();
				...
				String sql = "select * from donor where name like '%"+textvalue+"%'";
